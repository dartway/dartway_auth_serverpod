...
--
-- Class DwPhoneAuth as table dw_phone_auth
--
CREATE TABLE "dw_phone_auth" (
...
-- Indexes
CREATE INDEX "serverpod_phone_auth_phone" ON "dw_phone_auth" USING btree ("phoneNumber");

--
-- Class DwPhoneFailedSignIn as table dw_phone_failed_sign_in
--
...
--
-- Class DwRegistrationDataStash as table dw_registration_data_stash
--
